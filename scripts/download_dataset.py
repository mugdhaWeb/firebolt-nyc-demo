...
class DatasetDownloader:
    ...
    def clean_chunk(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        for col in string_columns:
            if col not in ['Issue Date', 'Vehicle Expiration Date', 'Date First Observed']:
...
def main():
    parser = argparse.ArgumentParser(description='Download NYC Parking Violations dataset')
